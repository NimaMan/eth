...
This module is responsible for fetching Ethereum blocks from an Reth node. It serves as the 
...
1. Establish and maintain a connection to an Reth node
...
class BlockFetcher:
    def __init__(self, node_url: str, max_retries: int = 3, retry_delay: float = 1.0):
        ...
        :param node_url: URL of the Reth node
    ...
    async def close(self):
        """
        Close the connection to the Reth node.
        """
