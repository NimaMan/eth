...
from eth_token_monitor.alert.bribe_alert import BribeAlert
from eth_token_monitor.alert.green_actor_alert import GreenActorAlert
from eth_token_monitor.alert.scam_alert import ScamAlert
