...
import numpy as np
import pandas as pd
from eth_token_monitor.live_erc20_token.network.live_token_network_builder import LiveTokenNetworkBuilder
from eth_token_analyzer.erc20_token.network.graph_simplifier import GraphSimplifier
from eth_token_analyzer.erc20_token.network.subgraph_analyzer import NetworkSubgraphAnalyzer


class LiveTokenNetwork(LiveTokenNetworkBuilder):
    def __init__(self, token_data, high_degree_node_threshold=3):
        """
