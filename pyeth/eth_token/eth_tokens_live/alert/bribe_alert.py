...
class BribeAlert(BaseAlert):
    ...
    def _is_alert(self, live_erc20_token: LiveERC20Token) -> bool:
        if live_erc20_token.total_bribe_amount > self.bribe_threshold:
            return True, live_erc20_token.total_bribe_amount
        return False, 0
    ...
    def create_alert(self, live_erc20_token: LiveERC20Token, bribe_value: float) -> BribeAlertData:
        ...
        return BribeAlertData(
            ...
            transaction_hash=live_erc20_token.transaction_hash,
            from_address=live_erc20_token.from_address,
            value=live_erc20_token.value,
