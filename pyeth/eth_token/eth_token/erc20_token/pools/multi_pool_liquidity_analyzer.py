...
from eth_token.erc20_token.pools.pool_data_models import PoolLiquiditySnapshot


class MultiPoolLiquidityAnalyzer:
    """Aggregates and tracks liquidity metrics across every pool for a token."""
    ...
    def snapshots(self) -> List[PoolLiquiditySnapshot]:
    ...
    # Pricing helpers
    # ------------------------------------------------------------------
    def get_best_price(self, *, for_buy: bool) -> Optional[Tuple[PoolLiquiditySnapshot, float]]:
        """
...
__all__ = ["MultiPoolLiquidityAnalyzer", "PoolLiquiditySnapshot"]
