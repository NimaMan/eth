...
- `protocols/uniswap_v2_trading_vault.rs`: Mode A vault builders for buy-through-vault and emergency approve+sell calldata
...
- `alpha/live/trading` wraps the direct V2 sell builder and the Uniswap V2 trading vault
