...
pub fn build_buy_swap(
    ...
    match *route {
        AmmSwapRoute::UniswapV2 { .. } => uniswap::v2::build_buy_swap_v2(
            uniswap::v2::Router::UniswapV2,
            buyer,
            token_out,
            amount_in_eth,
            slippage_bps,
        ...
        AmmSwapRoute::SushiswapV2 { .. } => uniswap::v2::build_buy_swap_v2(
            sushiswap::v2::DEFAULT_ROUTER,
            buyer,
            token_out,
            amount_in_eth,
            slippage_bps,
        ...
        AmmSwapRoute::V2Router { router, .. } => uniswap::v2::build_buy_swap_v2(
            uniswap::v2::Router::Custom(router),
            buyer,
            token_out,
            amount_in_eth,
            slippage_bps,
        ...
        AmmSwapRoute::UniswapV3 { fee_tier, .. } => uniswap::v3::build_buy_swap_v3(
            buyer,
            token_out,
            amount_in_eth,
            fee_tier,
        ...
        _ => uniswap::v2::build_buy_swap_v2(
            uniswap::v2::Router::UniswapV2,
            buyer,
            token_out,
            amount_in_eth,
...
pub fn build_buy_swap_with_min_out(
    ...
    match *route {
        AmmSwapRoute::UniswapV2 { .. } => uniswap::v2::build_buy_swap_v2_with_min_out(
            uniswap::v2::Router::UniswapV2,
            buyer,
            token_out,
            amount_in_eth,
        ...
        AmmSwapRoute::SushiswapV2 { .. } => uniswap::v2::build_buy_swap_v2_with_min_out(
            sushiswap::v2::DEFAULT_ROUTER,
            buyer,
            token_out,
            amount_in_eth,
        ...
        AmmSwapRoute::V2Router { router, .. } => uniswap::v2::build_buy_swap_v2_with_min_out(
            uniswap::v2::Router::Custom(router),
            buyer,
            token_out,
            amount_in_eth,
        ...
        AmmSwapRoute::UniswapV3 { fee_tier, .. } => uniswap::v3::build_buy_swap_v3_with_min_out(
            buyer,
            token_out,
            amount_in_eth,
            fee_tier,
        ...
        _ => uniswap::v2::build_buy_swap_v2_with_min_out(
            uniswap::v2::Router::UniswapV2,
            buyer,
            token_out,
            amount_in_eth,
...
pub fn build_approve_for_route(
    ...
    match *route {
        AmmSwapRoute::UniswapV2 { .. } => {
            uniswap::v2::build_approve_v2(uniswap::v2::Router::UniswapV2, owner, token, amount)
        }
        AmmSwapRoute::SushiswapV2 { .. } => {
            uniswap::v2::build_approve_v2(sushiswap::v2::DEFAULT_ROUTER, owner, token, amount)
        }
        ...
        _ => uniswap::v2::build_approve_v2(uniswap::v2::Router::UniswapV2, owner, token, amount),
    }
}
...
pub fn build_sell_swap(
    ...
    match *route {
        AmmSwapRoute::UniswapV2 { .. } => uniswap::v2::build_sell_swap_v2(
            uniswap::v2::Router::UniswapV2,
            seller,
            token_in,
            amount_in_tokens,
        ...
        AmmSwapRoute::SushiswapV2 { .. } => uniswap::v2::build_sell_swap_v2(
            sushiswap::v2::DEFAULT_ROUTER,
            seller,
            token_in,
            amount_in_tokens,
        ...
        AmmSwapRoute::V2Router { router, .. } => uniswap::v2::build_sell_swap_v2(
            uniswap::v2::Router::Custom(router),
            seller,
            token_in,
            amount_in_tokens,
        ...
        AmmSwapRoute::UniswapV3 { fee_tier, .. } => uniswap::v3::build_sell_swap_v3(
            seller,
            token_in,
            amount_in_tokens,
            fee_tier,
        ...
        AmmSwapRoute::V3Router {
            router, fee_tier, ..
        } => uniswap::v3::build_sell_swap_v3_with_router(
            router,
            seller,
            token_in,
            amount_in_tokens,
        ...
        _ => uniswap::v2::build_sell_swap_v2(
            uniswap::v2::Router::UniswapV2,
            seller,
            token_in,
            amount_in_tokens,
...
fn build_fee_tolerant_token_to_token_swap(
    ...
    match *route {
        AmmSwapRoute::UniswapV2 { .. } => uniswap::v2::build_token_to_token_swap_supporting_fee_v2(
            uniswap::v2::Router::UniswapV2,
            trader,
            token_in,
            token_out,
        ...
        AmmSwapRoute::SushiswapV2 { .. } => {
            uniswap::v2::build_token_to_token_swap_supporting_fee_v2(
                sushiswap::v2::DEFAULT_ROUTER,
                trader,
                token_in,
                token_out,
...
pub fn build_sell_swap_with_min_out(
    ...
    match *route {
        AmmSwapRoute::UniswapV2 { .. } => uniswap::v2::build_sell_swap_v2_with_min_out(
            uniswap::v2::Router::UniswapV2,
            seller,
            token_in,
            amount_in_tokens,
        ...
        AmmSwapRoute::SushiswapV2 { .. } => uniswap::v2::build_sell_swap_v2_with_min_out(
            sushiswap::v2::DEFAULT_ROUTER,
            seller,
            token_in,
            amount_in_tokens,
        ...
        AmmSwapRoute::V2Router { router, .. } => uniswap::v2::build_sell_swap_v2_with_min_out(
            uniswap::v2::Router::Custom(router),
            seller,
            token_in,
            amount_in_tokens,
        ...
        AmmSwapRoute::UniswapV3 { fee_tier, .. } => uniswap::v3::build_sell_swap_v3_with_min_out(
            seller,
            token_in,
            amount_in_tokens,
            fee_tier,
        ...
        _ => uniswap::v2::build_sell_swap_v2_with_min_out(
            uniswap::v2::Router::UniswapV2,
            seller,
            token_in,
            amount_in_tokens,
...
pub fn build_token_to_token_swap(
    ...
    match *route {
        AmmSwapRoute::UniswapV2 { .. } => uniswap::v2::build_token_to_token_swap_v2(
            uniswap::v2::Router::UniswapV2,
            trader,
            token_in,
            token_out,
        ...
        AmmSwapRoute::SushiswapV2 { .. } => uniswap::v2::build_token_to_token_swap_v2(
            sushiswap::v2::DEFAULT_ROUTER,
            trader,
            token_in,
            token_out,
        ...
        AmmSwapRoute::V2Router { router, .. } => uniswap::v2::build_token_to_token_swap_v2(
            uniswap::v2::Router::Custom(router),
            trader,
            token_in,
            token_out,
        ...
        _ => uniswap::v2::build_token_to_token_swap_v2(
            uniswap::v2::Router::UniswapV2,
            trader,
            token_in,
            token_out,
...
pub fn build_token_to_token_swap_with_min_out(
    ...
    match *route {
        AmmSwapRoute::UniswapV2 { .. } => uniswap::v2::build_token_to_token_swap_v2_with_min_out(
            uniswap::v2::Router::UniswapV2,
            trader,
            token_in,
            token_out,
        ...
        AmmSwapRoute::SushiswapV2 { .. } => uniswap::v2::build_token_to_token_swap_v2_with_min_out(
            sushiswap::v2::DEFAULT_ROUTER,
            trader,
            token_in,
            token_out,
        ...
        AmmSwapRoute::V2Router { router, .. } => {
            uniswap::v2::build_token_to_token_swap_v2_with_min_out(
                uniswap::v2::Router::Custom(router),
                trader,
                token_in,
                token_out,
        ...
        AmmSwapRoute::UniswapV3 { fee_tier, .. } => {
            uniswap::v3::build_token_to_token_swap_v3_with_min_out(
                trader,
                token_in,
                token_out,
                amount_in,
        ...
        _ => uniswap::v2::build_token_to_token_swap_v2_with_min_out(
            uniswap::v2::Router::UniswapV2,
            trader,
            token_in,
            token_out,
...
pub fn build_sell_with_permit(
    ...
    match *route {
        AmmSwapRoute::UniswapV3 { fee_tier, .. } => uniswap::v3::build_sell_with_self_permit_v3(
            seller,
            token_in,
            amount_in_tokens,
            fee_tier,
