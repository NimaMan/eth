...
| ETH tx executor policy | partial | Candidate policy has from address and buy/sell selectors; current live ETH tx executor rejects V4 target/selectors until a deployed V4 target is allowlisted. |
