...
impl LogDecoder {
    ...
    fn decode_uniswap_v2_pair_created(
        &self,
        log: &AlloyLog,
        log_index: u64,
    ) -> Result<Option<DecodedEvent>> {
    ...
    fn decode_uniswap_v3_pool_created(
        &self,
        log: &AlloyLog,
        log_index: u64,
    ) -> Result<Option<DecodedEvent>> {
    ...
    fn decode_uniswap_v3_initialize(
        &self,
        log: &AlloyLog,
        log_index: u64,
    ) -> Result<Option<DecodedEvent>> {
    ...
    fn decode_uniswap_v4_initialize(
        &self,
        log: &AlloyLog,
        log_index: u64,
    ) -> Result<Option<DecodedEvent>> {
    ...
    fn decode_uniswap_v4_modify_liquidity(
        &self,
        log: &AlloyLog,
        log_index: u64,
    ) -> Result<Option<DecodedEvent>> {
    ...
    fn decode_uniswap_v4_protocol_fee_updated(
        &self,
        log: &AlloyLog,
        log_index: u64,
    ) -> Result<Option<DecodedEvent>> {
    ...
    fn decode_uniswap_v4_dynamic_lp_fee_updated(
        &self,
        log: &AlloyLog,
        log_index: u64,
    ) -> Result<Option<DecodedEvent>> {
    ...
    fn decode_uniswap_v4_protocol_fee_controller_updated(
        &self,
        log: &AlloyLog,
        log_index: u64,
    ) -> Result<Option<DecodedEvent>> {
    ...
    fn decode_uniswap_v4_balance_delta(
        &self,
        log: &AlloyLog,
        log_index: u64,
    ) -> Result<Option<DecodedEvent>> {
    ...
    fn decode_uniswap_v3_increase_liquidity(
        &self,
        log: &AlloyLog,
        log_index: u64,
    ) -> Result<Option<DecodedEvent>> {
    ...
    fn decode_uniswap_v3_decrease_liquidity(
        &self,
        log: &AlloyLog,
        log_index: u64,
    ) -> Result<Option<DecodedEvent>> {
    ...
    fn decode_ownership_transferred(
        &self,
        log: &AlloyLog,
        log_index: u64,
    ) -> Result<Option<DecodedEvent>> {
