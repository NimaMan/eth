...
impl TransactionLoader {
    ...
    pub fn new(reth_datadir: &str) -> Result<Self> {
        info!("Initializing TransactionLoader with datadir: {}", reth_datadir);
    ...
    pub fn with_provider_factory(
        ...
        info!("Initializing TransactionLoader with shared provider factory");
    ...
    pub async fn load_transaction_data(&self, tx_hash: B256) -> Result<(
        ...
        info!("Loading transaction data: {}", tx_hash);
