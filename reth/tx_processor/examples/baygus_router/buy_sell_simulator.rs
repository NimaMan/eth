...
fn main() -> Result<()> {
    ...
    // rt is implicitly dropped here

    simulation_result
}

async fn run_simulation(simulator: Arc<TxSimulator>) -> Result<()> {
    println!("🦄 Baygus Universal Router - Buy/Sell Simulation");
    println!("================================================\n");
    ...
    println!("Swapping {} WETH for USDC on Uniswap V2", format_wei(amount_in));
    ...
    println!("{:?}", sell_processed.address_balance_changes);
