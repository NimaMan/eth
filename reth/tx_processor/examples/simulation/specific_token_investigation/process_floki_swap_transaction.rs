...
async fn main() -> Result<()> {
    ...
    let block_number = 23245765u64;
    let simulation_block = block_number - 1; // Simulate at block before mining
    
    println!("📊 Transaction: {}", tx_hash);
    println!("📦 Mined in block: {}", block_number);
    println!("🔧 Simulating at block: {}", simulation_block);
