...
const UNIV3_USDC_DAI_5_BPS_POOL: Address = address!("0x5777d92F208679DB4b9778590Fa3CAB3aC9e2168");
...
async fn main() -> Result<()> {
    ...
    println!("Pool : {UNIV3_USDC_DAI_5_BPS_POOL:#x}");
    ...
    let config = PoolBuySellParameters::new(
        DAI_ADDRESS,
        UNIV3_USDC_DAI_5_BPS_POOL,
        PoolType::UniswapV3 { fee_tier: 500 },
    )
