...
impl FundFlowAnalyzer {
    ...
    /// Analyze fund flows from simulation results
    pub fn analyze_fund_flows(&self, flows: &[CompleteFundFlows]) -> QarqaResult<Vec<FundFlow>> {
        ...
        for complete_flows in flows {
            ...
            for eth_movement in &complete_flows.eth_movements {
                ...
                accumulator.add_eth_movement(eth_movement);
            }
            ...
            for token_movement in &complete_flows.token_movements {
                ...
                if self.treat_weth_as_eth && is_weth_address(token_movement.token_address) {
                    ...
                    accumulator.add_token_movement(token_movement);
                }
            }
        }
...
impl FundFlowAccumulator {
    ...
    fn add_eth_movement(&mut self, movement: &EthMovement) {
    ...
    fn add_token_movement(&mut self, movement: &TokenMovement) {
