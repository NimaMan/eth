...
The Core Types module provides the foundational data structures, error types, and utilities shared across all QARQA components. This module has minimal dependencies and serves as the foundation for the entire QARQA analytics system.
...
### **Running Tests**
```bash
cd /home/nima/code/crypto/rust/qarqa/core_types
cargo test
```
...
This module provides the foundation for all QARQA operations, ensuring type safety, performance, and consistency across the entire analytics system.