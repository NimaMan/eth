...
use qarqa_fundflownetwork::extract_fund_flows_from_processed_tx;
use qarqa_core_types::EthMovementType;
        ...
        Ok(processed_tx) => {
            ...
            match extract_fund_flows_from_processed_tx(&processed_tx) {
                Ok(fund_flows) => {
                    ...
                    // Check gas fees
                    let gas_cost = processed_tx.fees.gas_price * alloy_primitives::U256::from(processed_tx.fees.gas_used);
