...
//! [`ChainDataLoader`] instead of open-coding MDBX/Redis fallbacks.
...
/// Block state returned by [`ChainDataLoader`].
...
pub struct ChainDataLoader<'a> {
    simulator: &'a TxSimulator,
}

impl<'a> ChainDataLoader<'a> {
