...
pub static DENOM_ADDRESSES: Lazy<HashMap<Address, &'static str>> = Lazy::new(|| {
    ...
    m.insert(address!("5E8422345238F34275888049021821E8E08CAa1f"), "frxETH");
    ...
    m.insert(address!("7D1AfA7B718fb893dB30A3aBc0Cfc608AaCfeBB0"), "MATIC");
    ...
    m.insert(address!("39AA39c021dfbaE8faC545936693aC917d5E7563"), "cUSDC");
    ...
    m.insert(address!("06325440D014e39736583c165C2963BA99fAf14E"), "stETH-ETH");
    m.insert(address!("dA816459F1AB5631232FE5e97a05BBBb94970c95"), "yvDAI");
    m.insert(address!("a354F35829Ae975e850e23e9615b11Da1B3dC4DE"), "yvUSDC");
    m.insert(address!("ae7ab96520DE3A18E5e111B5EaAb095312D7fE84"), "stETH");
    m.insert(address!("Be9895146f7AF43049ca1c1AE358B0541Ea49704"), "cbETH");
    ...
    m.insert(address!("6B3595068778DD592e39A122f4f5a5cF09C90fE2"), "SUSHI");
    m.insert(address!("ba100000625a3754423978a60c9317c58a424e3D"), "BAL");
    m.insert(address!("111111111117dC0aa78b770fA6A738034120C302"), "1INCH");
    ...
    m.insert(address!("1aBaEA1f7C830bd89Acc67EC4af516284b1bC33c"), "EUROC");
    m.insert(address!("5F7827FDeb7c20b443265Fc2F40845B715385Ff2"), "EURCV");
    ...
    m.insert(address!("c5f0F7B66764F6EC8c8dFF7Ba683102295E16409"), "FDUSD");
    ...
    m.insert(address!("431d5dff03120afa4bdf332c61a6e1766ef37bdb"), "JPYCv2");
    m.insert(address!("4591DBfF62656E7859Afe5e45f6f47D3669fBB28"), "MKUSD");
    ...
    m.insert(address!("6c3EA9036406852006290770BEdFcAbA0e23A0E8"),"PYUSD",);
    ...
    m.insert(address!("cf0C122c6b73ff809C693DB761e7BaeBe62b6a2E"), "FLOKI");
    ...
    m.insert(address!("A2b4C0Af19cC16a6CfAcCe81F192B024d625817D"), "KISHU");
    ...
    m.insert(address!("42981d0bfbAf196529376EE702F2a9Eb9092fcB5"), "SAFEMOON");
    ...
    m.insert(address!("3301Ee63Fb29F863f2333Bd4466acb46CD8323E6"), "AKITA");
    m.insert(address!("BB0E17EF65F82Ab018d8EDd776e8DD940327B28b"), "AXS");
    m.insert(address!("AC57De9C1A09FeC648E93EB98875B212DB0d460B"), "BABYDOGE");
    m
});
