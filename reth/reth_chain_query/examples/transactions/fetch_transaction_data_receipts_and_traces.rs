...
async fn main() -> Result<()> {
    ...
    let tx_hash =
        B256::from_str("0x3feab7d74656d4f3ea4814ec450eedc9875c7e8e856270951334cf66da6e14da")?;
    ...
    if provider.transaction_exists(tx_hash).await? {
        ...
        println!(
            "  Block: #{} (timestamp: {})",
            tx_data.block_number, tx_data.block_timestamp
        );
