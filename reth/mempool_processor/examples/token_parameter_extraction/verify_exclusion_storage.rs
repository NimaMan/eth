...
async fn main() -> Result<()> {
    ...
    let test_cases = vec![
        (
            "Successful Seller",
            Address::from_str("0x6D356ab697B0AB2A871B6Be79073A35664340440")?,
        ),
        (
            "Token Owner",
            Address::from_str("0x62ed63ce328665488914992b247b1ef8f78199a1")?,
        ),
        (
            "Our Test Address",
            Address::from_str("0x0C96c602b1b332B8AB2093E5d72D804a24bd5689")?,
        ),
        (
            "Maestro Router",
            Address::from_str("0x80a64c6D7f12C47B7c66c5B4E20E72bc1FCd5d9e")?,
        ),
        (
            "Uniswap V2 Router",
        ...
        (
            "Uniswap V2 Pair",
            Address::from_str("0x5423621C6D3E22465876deb92aD4f40Dc25b62A3")?,
        ),
    ];
