...
CREATE TABLE IF NOT EXISTS token_pnl.pool_address_pnl (
    ...
    denom_cashflow DOUBLE PRECISION,
    native_fee DOUBLE PRECISION,
    native_bribe DOUBLE PRECISION,
    marked_token_value_denom DOUBLE PRECISION,
    pnl_proxy_denom DOUBLE PRECISION,
    first_block BIGINT,
    latest_block BIGINT,
