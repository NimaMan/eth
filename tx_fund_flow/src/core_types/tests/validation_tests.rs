    ...
    fn test_valid_ethereum_addresses() {
        ...
        for (address, description) in valid_addresses {
            ...
            assert_eq!(
                ...
                "Address normalization failed for {}",
                description
            );
        }
    }
...
mod transaction_hash_validation_tests {
    ...
    fn test_invalid_transaction_hashes() {
        ...
        let invalid_hashes = vec![
            ...
            ("0x123", "Too short"),
            (
                "f7bd63f7b61b4dc88ffb081a05d0e29b6558649802285838128c10fc9ce6c006",
                "Missing 0x",
            ),
            (
                "0xZZZZ63f7b61b4dc88ffb081a05d0e29b6558649802285838128c10fc9ce6c006",
                "Invalid hex",
            ),
            (
                "0xf7bd63f7b61b4dc88ffb081a05d0e29b6558649802285838128c10fc9ce6c00",
                "Too short (65)",
            ),
            (
                "0xf7bd63f7b61b4dc88ffb081a05d0e29b6558649802285838128c10fc9ce6c0066",
                "Too long (67)",
            ),
        ];
...
mod numeric_validation_tests {
    ...
    fn test_u256_validation() {
        ...
        assert!(validator
            .validate_u256("0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff")
            .is_ok());
        ...
        assert!(validator.validate_u256("12.34").is_err()); // Raw U256 values are integers
    }
    ...
    fn test_block_range_validation() {
        ...
        assert!(validator
            .validate_block_range(17_000_000, 17_100_000)
            .is_ok());
...
mod sql_identifier_tests {
    ...
    fn test_sql_reserved_words() {
        ...
        let reserved_words = vec![
            "SELECT", "INSERT", "UPDATE", "DELETE", "DROP", "CREATE", "ALTER", "select", "Select",
