...
use crate::common_addresses::cex::{exchange_stats, get_exchange_addresses};
...
impl RethQueryProvider {
    ...
    pub async fn get_all_cex_balances(&self, block: Option<u64>) -> Result<CexBalanceSummary> {
        ...
        exchanges.sort_by(|a, b| b.total_eth_balance.cmp(&a.total_eth_balance));
