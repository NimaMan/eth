//! PancakeSwap V3 pool utilities for Ethereum mainnet.
...
/// Standard fee tiers for PancakeSwap V3.
...
/// Query PancakeSwap V3 factory for a token pair and fee tier using a view call.
