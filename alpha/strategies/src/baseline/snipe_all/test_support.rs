...
pub(super) fn confirmed_position(strategy: &SnipeAllStrategy, pool: &PoolSnapshot) -> Position {
...
pub(super) fn failed_exit_position(strategy: &SnipeAllStrategy, pool: &PoolSnapshot) -> Position {
