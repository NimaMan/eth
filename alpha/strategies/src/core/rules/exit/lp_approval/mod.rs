...
pub fn evaluate(
    ...
    if !crate::core::rules::lp_approval::approval_exceeds_threshold(event, min_pct) {
...
fn approval_age_evidence(
    ctx: &StrategyContext<'_>,
    event: &RiskEvent,
) -> Option<crate::core::rules::lp_approval::ApprovalAgeEvidence> {
    crate::core::rules::lp_approval::approval_age_evidence(event)
...
fn approval_age_from_pool_creation(
    ...
    Some(crate::core::rules::lp_approval::ApprovalAgeEvidence {
