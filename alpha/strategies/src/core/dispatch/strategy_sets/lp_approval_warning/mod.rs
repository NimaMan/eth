...
pub fn spec(_options: &LiveStrategySpecOptions) -> LiveStrategySpec {
    LiveStrategySpec {
        ...
        exit_tax: crate::core::rules::lp_approval_warning_exit::EXIT_TAX,
        exit_lp_approval: crate::core::rules::lp_approval_warning_exit::EXIT_LP_APPROVAL,
        exit_lp_approval_critical_only:
            crate::core::rules::lp_approval_warning_exit::EXIT_LP_APPROVAL_CRITICAL_ONLY,
        exit_scam: crate::core::rules::lp_approval_warning_exit::EXIT_SCAM,
