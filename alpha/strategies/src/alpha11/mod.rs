...
pub use config::{
    ...
    ENTRY_INIT_MAX_PRICE_RATIO_TO_INITIAL, HOLD15_STRATEGY_NAME, HOLD3_VALIDATION_STRATEGY_NAME,
    HOLD_SWEEP_SET_NAME, INITIAL_ENTRY_BANKROLL_ETH, LIVE_VALIDATION_ENTRY_BANKROLL_ETH,
    LIVE_VALIDATION_MAX_ENTRY_POOLS, MIN_LIQUIDITY_ETH, MIN_LIQUIDITY_USD, STRATEGY_IMPL,
};
