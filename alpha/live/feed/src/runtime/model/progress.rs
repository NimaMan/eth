...
pub struct LiveTokenProgress {
    ...
    pub pool_simulation_failures: usize,
    ...
    pub processed_block_address_index_failures: u64,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub last_processed_block_address_index_warning: Option<String>,
...
impl LiveTokenProgress {
    pub fn idle(history_limit: usize) -> Self {
        ...
        Self {
            ...
            processed_block_address_index_failures: 0,
            last_processed_block_address_index_warning: None,
