...
pub use crate::{
    EthTxBribeRequest, EthTxSimulationReference, EthTxSubmitDirectRawResult,
...
pub enum EthTxExecutorBroadcastMode {
    DryRun,
    Broadcast,
    #[serde(other)]
    Unknown,
...
impl EthTxExecutorBroadcastMode {
...
pub struct EthTxExecutorStatus {
    ...
    pub policy: EthTxPolicyStatus,
}

#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct EthTxPolicyStatus {
    pub version: String,
    ...
    pub daily_spend: EthTxDailySpendStatus,
...
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct EthTxDailySpendStatus {
...
mod tests {
    ...
    fn status_decodes_dry_run_policy_summary() {
        let status: EthTxExecutorStatus = serde_json::from_value(json!({
