...
| Status | Token | Pool | Range / Block | Symptom | Why It Matters | Investigation |
| --- | --- | --- | --- | --- | --- | --- |
| fixed | MOTH `0xec402ba62e9d67650359ba859ddc1ae22a84840f` | `0x43cc493e758bfb50ff0f84ca188e2555145bef2d` | blocks `25,063,339` through `25,063,350`, tx `0x84b4c5eca672c72363048b0b49f47cdfb15bda3953e69138b0252e0c76437510` | live token detail showed `PAIR_CREATION`, `risk=clear`, and `pools=0` while mempool signals showed a `DRAINING` liquidity removal with `98.45%` drain | live retention should keep newly scammed pools for a bounded `15,000`-block inspection window before pruning them | mothman_live_retention_liquidity_removal_25063339 |
