...
contract MockReentrantReceiver {
    BaygusExecutor public immutable ROUTER;
    bool public attempted;
    bool public innerSucceeded;

    constructor(BaygusExecutor router_) {
        ROUTER = router_;
    }
    ...
    receive() external payable {
        ...
        (innerSucceeded,) = address(ROUTER).call(abi.encodeCall(BaygusExecutor.execute, (commands, inputs)));
    }
}
